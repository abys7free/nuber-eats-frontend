...
describe('<CreateAccount />', () => {
  ...
  it('submits mutation with form values', async () => {
    ...
    const mockedCreateAccountResponse = jest.fn().mockResolvedValue({
      data: {
        createAccount: {
          ok: true,
    ...
    expect(mockedCreateAccountResponse).toHaveBeenCalledTimes(1);
    expect(mockedCreateAccountResponse).toHaveBeenCalledWith({
      createAccountInput: {
